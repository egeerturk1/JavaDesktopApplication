...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void newAdd(){
        dispose();
        AddLocation addLocation = new AddLocation(username);
        addLocation.setVisible(true);
    }
    private void newDeletePage(){
        dispose();
        DeleteVisit deleteVisit = new DeleteVisit(username);
        deleteVisit.setVisible(true);
    }
    private void editVisit() {
        dispose();
        EditVisit editVisit = new EditVisit(username);
        editVisit.setVisible(true);
    }
      private void visitInformations() {
          dispose();
          DisplayVisits visitInformation = new DisplayVisits(username);
          visitInformation.setVisible(true);
    }
    /**
    ...
    private void initComponents() {
        ...
        jButton3.setText("Display/Edit Visit");
        ...
        jButton4.setText("Display informations about countries and visits and SHARE VİSİT");
